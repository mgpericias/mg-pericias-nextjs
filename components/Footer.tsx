        ...
        <div className="foot-grid">
          ...
          <div className="foot-logo">
            ...
            <div className="foot-social">
              ...
              <a href="https://www.instagram.com/mgpericias" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/profile.php?id=61590443963195" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg viewBox="0 0 24 24"><path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07c0 6.03 4.39 11.03 10.13 11.93v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.69.24 2.69.24v2.97h-1.52c-1.49 0-1.96.93-1.96 1.89v2.25h3.33l-.53 3.49h-2.8V24C19.61 23.1 24 18.1 24 12.07z"/></svg>
              </a>
            </div>
          </div>
        </div>
