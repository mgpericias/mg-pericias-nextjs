...
const UP = "https://mgpericias.com.br/wp-content/uploads";
    ...
    <>
      ...
      <div className="clientes">
        <div className="wrap clientes-row">
          {CLIENTES.map((c) => (
            <img key={c} src={`${UP}/2025/04/${c}.png`} alt={c} />
          ))}
        </div>
      </div>
      ...
      <section className="quem" id="quem-somos">
        <div className="wrap">
          <div className="quem-top">
            ...
            <img src={`${UP}/2025/10/TIME-MG-1.jpg`} alt="Equipe MG Perícias" />
          </div>
        </div>
      </section>
          ...
          <div className="equipe-grid">
            {EQUIPE.map((m) => (
              <div className="membro" key={m.nome}>
                <img src={`${UP}/2025/10/${m.img}.jpg`} alt={m.nome} />
